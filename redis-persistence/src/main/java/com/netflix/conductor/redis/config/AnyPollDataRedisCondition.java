...
public class AnyPollDataRedisCondition extends AnyNestedCondition {

    public AnyPollDataRedisCondition() {
    ...
    @ConditionalOnProperty(name = "conductor.poll-data-dao.type", havingValue = "redis_cluster")
    static class PollDataRedisClusterConfiguration {}

    @ConditionalOnProperty(name = "conductor.poll-data-dao.type", havingValue = "redis_sentinel")
    static class PollDataRedisSentinelConfiguration {}

    @ConditionalOnProperty(name = "conductor.poll-data-dao.type", havingValue = "redis_standalone")
    static class PollDataRedisStandaloneConfiguration {}
}
